...
export const Hero = () => {
  return (
    <section className="min-h-screen flex items-center bg-clay-cream pt-16">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-up">
          <div className="inline-block px-4 py-1.5 bg-clay-orange/20 rounded-full text-sm text-clay-forest mb-6">
            <span role="text" aria-label="Special offer">✨ Limited Time: Join Our Pilot Program</span>
          </div>
          
          <header className="space-y-4">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-clay-forest leading-tight">
              The AI Assistant
              <span className="block text-clay-sage">For Your Spa Business</span>
            </h1>
          </header>
          
          <p className="text-xl text-clay-forest/80 max-w-2xl mx-auto">
          ...
          <div className="max-w-xl mx-auto p-2">
            <button
              ...
              className="clay-button w-full h-14 flex items-center justify-center gap-2"
            >
              Join Waitlist
          ...
          <div className="text-center mt-20">
            <p className="text-clay-forest/70 text-sm uppercase tracking-wider mb-8">
              Works with your favorite spa software
            </p>
            <div className="clay-card" role="list" aria-label="Supported spa software platforms">
