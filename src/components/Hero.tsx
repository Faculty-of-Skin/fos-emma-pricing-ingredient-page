          ...
          <div className="max-w-2xl mx-auto p-2">
            ...
            >
              ...
              >
                ...
                <button
                  type="submit"
                  className="bg-brutal-dark hover:bg-brutal-black transition-colors text-white font-bold py-3 px-8 font-mono uppercase text-sm md:text-base flex items-center justify-center min-w-[60px]"
